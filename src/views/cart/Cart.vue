<template>
  <div class="cart-wrapper">
    <div v-if="cartList.length">
      <div class="cart-box">
        <div class="cart-item van-hairline--bottom" v-for="(item,index) in cartList" :key="index">
          <div class="cart-item-main">
            <div class="cart-item-checkbox" @click="_toggleSingleChecked(item.id)">
            ...
            <div class="cart-item-ctrl">
              ...
              <div class="bottom-box">
                <div class="cart-item-counts">
                  <!-- btn-ctrl -->
                  <a href="javascript:;" class="btn cut" :class="item.count===1?'disabled':''" data-type="cut" @click="cutItem(item.id)">-</a>
                  <a href="javascript:;" class="count">{{item.count}}</a>
                  <a href="javascript:;" class="btn add" data-type="add" @click="addItem(item.id)">+</a>
                </div>
                <span class="delete" @click="delItem(item.id)">×</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="cart-footer">
        <div class="all-select" @click="_toggleAllChecked">
          <img src="~@/assets/icon/all@selected.png" v-if="isAllChecked" alt="all">
          <img src="~@/assets/icon/all.png" alt="all" v-else>
          <span>{{allCheckedText}}</span>
        </div>
        <div class="all-price-cutmit" :class="tolalPrice===0?'disabled':''" @click="onSubmit">
          <!-- // pointer-events: none; -->
